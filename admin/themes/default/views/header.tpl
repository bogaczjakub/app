        ...
        <form id="search-form" method="POST" target="_self" class="navbar-form navbar-left">
            <div class="btn-group">
                <input type="text" class="form-control search-input" placeholder="Search"
                    name="search-form_search_input">
                <input type="hidden" class="form-control search-selector-input"
                    name="search-form_search_selector_input">
                ...
                <button type="submit" class="btn btn-primary search-submit"><span
        ...
        <ul id="admin-shortcut-dropdown" class="nav navbar-nav admin-navbar-dropdown">
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                    aria-expanded="false"><span class="glyphicon glyphicon-star"></span></span>Shortcuts <span
                        class="caret"></span></a>
        ...
        <ul id="admin-user-dropdown" class="nav navbar-nav navbar-right admin-navbar-dropdown">
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    !empty($session.logged_user.user_name)}{$session.logged_user.user_name}{/if} <span
                        class="caret"></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li role="separator" class="divider"></li>
                    <li class="logout-li"><a target="_self"
                            href="{$page_url}&module[name]=login&module[action]=logout"><span
                                class="glyphicon glyphicon-share"></span><span class="dropdown-text">Logout</span></a>
                    </li>
                </ul>
            </li>
        </ul>
