...
function style() {
    return (
        ...
        // gulp.src('modules/loginModule/admin/themes/default/sass/*.scss').pipe(sass()).on('error', sass.logError).pipe(gulp.dest('modules/loginModule/admin/themes/default/css/'))
    );
}

function watch() {
    // gulp.watch('admin/themes/default/sass/*.scss', style)
    gulp.watch('front/themes/default/sass/*.scss', style)
    // gulp.watch('modules/navigationModule/admin/themes/default/sass/*.scss', style)
    // gulp.watch('modules/loginModule/admin/themes/default/sass/*.scss', style)
}
